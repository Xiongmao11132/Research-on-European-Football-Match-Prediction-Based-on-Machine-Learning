...
#
# # 定义元模型
# meta_model = XGBClassifier(eval_metric='logloss', random_state=1, n_jobs=-1)
#
# # 定义堆叠模型
...
# joblib.dump(train_columns, 'train_columns_stack_XGB.pkl')

# 新数据集验证
new_data_path = r"D:\desk\Oddsprediction\Datasets\Processed_merged_SMOTE_output_2024.csv"
...
train_columns = joblib.load('train_columns_stack_GBDT.pkl')
X_new = X_new.reindex(columns=train_columns, fill_value=0)

# 使用堆叠模型预测新数据
stack_model = joblib.load('stack_model_stack_GBDT.pkl')
