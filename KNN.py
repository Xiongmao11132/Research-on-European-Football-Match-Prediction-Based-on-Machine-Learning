...
# 参数分布
param_grid = {
    'n_neighbors': [15,20,50,100,200,300],
    'weights': ['distance'],
    'metric': ['manhattan']
}
...
joblib.dump(train_columns, 'train_columns_KNN.pkl')
...
train_columns = joblib.load('train_columns_KNN.pkl')
...
# 读取新的数据集进行验证
processed_data = r"D:\desk\Oddsprediction\Datasets\Processed_merged_SMOTE_output_2024.csv"
merged_df = pd.read_csv(processed_data)
X_new = merged_df.drop('FTR', axis=1)
y_true = merged_df['FTR']
