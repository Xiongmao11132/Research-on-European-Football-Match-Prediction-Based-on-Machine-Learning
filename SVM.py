...
# 模型选择
model = SVC(max_iter=10000, random_state=1)
...
os.environ['JOBLIB_TEMP_FOLDER'] = '/data/coding/temp_joblib'
...
joblib.dump(train_columns, 'train_columns_SVM.pkl')
...
train_columns = joblib.load('train_columns_SVM.pkl')
...
# # 模型选择，使用指定参数直接训练 SVM 模型
# model = SVC(random_state=1, max_iter=1000000)
